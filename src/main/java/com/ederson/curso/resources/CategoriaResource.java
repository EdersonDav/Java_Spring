...
import com.ederson.curso.services.CategoriaService;
...
public class CategoriaResource {
	...
	public ResponseEntity <List<CategoriaDTO>> findAll() {
		...
		List<CategoriaDTO> listDTO = objList.stream().map(dto -> new CategoriaDTO(dto)).collect(Collectors.toList());
	...
	public ResponseEntity <Page<CategoriaDTO>> findPage(
		...
		Page<CategoriaDTO> listDTO = objList.map(dto -> new CategoriaDTO(dto));
		return ResponseEntity.ok().body(listDTO);
	}
